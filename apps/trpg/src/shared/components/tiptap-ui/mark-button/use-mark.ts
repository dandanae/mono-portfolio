...
// --- Icons ---
import { BoldIcon } from '@/shared/components/tiptap-icons/bold-icon';
import { Code2Icon } from '@/shared/components/tiptap-icons/code2-icon';
import { ItalicIcon } from '@/shared/components/tiptap-icons/italic-icon';
import { StrikeIcon } from '@/shared/components/tiptap-icons/strike-icon';
import { SubscriptIcon } from '@/shared/components/tiptap-icons/subscript-icon';
import { SuperscriptIcon } from '@/shared/components/tiptap-icons/superscript-icon';
import { UnderlineIcon } from '@/shared/components/tiptap-icons/underline-icon';
// --- Hooks ---
